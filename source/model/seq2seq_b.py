...
from source.module.rnn_decoder_b import RNNDecoder
...
class Seq2Seq_B(BaseModel):
    ...
    def decode(self, dec_inputs, state):
        ...
        log_logits = torch.log(con_logits + 1e-12)
    ...
    def forward(self, enc_inputs, dec_inputs, hidden=None):
        ...
        outputs.add(logits=log_logits, gate_logits=gate_logits,
                    ...
                    kb_state_memory=dec_state.kb_state_memory,prob=con_logits)
        return outputs
